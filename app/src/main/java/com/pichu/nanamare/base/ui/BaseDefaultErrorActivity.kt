...
import com.pichu.nanamare.databinding.DefaultErrorActivityBinding

class BaseDefaultErrorActivity :
    BaseActivity<DefaultErrorActivityBinding>(R.layout.default_error_activity) {
